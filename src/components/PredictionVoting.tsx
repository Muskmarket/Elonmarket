          ...
          <div className="space-y-6">
            <Card className="bg-card border-border">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="mt-4 p-2.5 sm:p-3 rounded-lg bg-muted/30 border border-border/50 flex items-start gap-2.5">
                  <Gift className="w-3.5 sm:w-4 h-3.5 sm:h-4 text-neon-orange shrink-0 mt-0.5" />
                  <p className="text-[10px] sm:text-base leading-relaxed text-muted-foreground">
